  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, your one-stop solution for seamless table reservations and efficient restaurant management. Elevate your dining experience with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, your one-stop solution for seamless table reservations and efficient restaurant management. Elevate your dining experience with us.`}
            </Text>
            <Box
